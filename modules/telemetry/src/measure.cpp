...
public:
  explicit Measure();
  static void registerMeasureSink(std::unique_ptr<IMeasureSink> sink);
...
void registerMeasureSink(std::unique_ptr<IMeasureSink> sink) {
  Measure::registerMeasureSink(std::move(sink));
}
...
void Measure::registerMeasureSink(std::unique_ptr<IMeasureSink> sink) {
